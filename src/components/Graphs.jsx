...
const Marks = ({ data, type, yScale, xScale }) => {
    ...
    if(type == 'daily') {
        const maxTempData = data.map(d => ({temperature: d.temperature.maxTemp, date: d.date, icon: d.icon}))
        const minTempData = data.map(d => ({temperature: d.temperature.minTemp, date: d.date, icon: d.icon}))
    ...
    return (
        <svg width={width} height={height}>
            ...
            >
                ...
                <Marks data={data} type={type} yScale={yScale} xScale={xScale} />
                <GraphLines
                    data={data}
                    yScale={yScale}
                    xScale={xScale}
